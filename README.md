...
## 6) Slide tasks implemented

From your slide tasks:
- ✅ Authentication & Authorization (RBAC) using Spring Security
- ✅ Docker containerization
- ✅ Database migration with Liquibase

---

If you want, you can extend it further with:
- semesters/sections, class schedules, prerequisites
- attendance
- transcript & GPA rules
- “student request to drop course” approvals
- email notifications
